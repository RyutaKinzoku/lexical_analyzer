...
typedef struct Tokens{
    ...
    enum tokenCode {AUTO, BREAK, CASE, CHAR, CONST, CONTINUE, DEFAULT, DO, ELSE, ENUM, EXTERN, DOUBLE, FLOAT, FOR,
        ...
        LBRACKET, RBRACKET, COMMA, SEMICOLON, ID, INTLITERAL, FLOATLITERAL, DOUBLELITERAL, CHARLITERAL, INVALIDSUFFIX, PLUSEQOP, 
        MINUSEQOP, ASTERISKEQOP, SLASHEQOP, PERCENTOP, PERCENTEQOP, PLUSPLUSOP, MINUSMINUSOP, LESSOP, GREATEROP, LESSEQOP, 
        GREATEREQOP, COMPAREEQOP, COMPAREDIFOP, NOTOP, ANDOP, OROP, LSHIFTLOP, LSHIFTEQOP, RSHIFTLOP, RSHIFTEQOP, COMPLEMENTOP, 
        BINANDOP, BINANDEQOP, BINOROP, BINOREQOP, BINXOROP, BINXOREQOP, POINTERMEMBEROP, MEMBEROP, QUESTIONOP, COLONOP, ENDOF} code;
} token;
...
const string tokenNames[] = {"AUTO", "BREAK", "CASE", "CHAR", "CONST", "CONTINUE", "DEFAULT", "DO", "ELSE", "ENUM", "EXTERN", "DOUBLE", "FLOAT", "FOR",
        ...
        "MINUSEQOP", "ASTERISKEQOP", "SLASHEQOP", "PERCENTOP", "PERCENTEQOP", "PLUSPLUSOP", "MINUSMINUSOP", "LESSOP", "GREATEROP", "LESSEQOP", 
        "GREATEREQOP", "COMPAREEQOP", "COMPAREDIFOP", "NOTOP", "ANDOP", "OROP", "LSHIFTLOP", "LSHIFTEQOP", "RSHIFTLOP", "RSHIFTEQOP", "COMPLEMENTOP", 
        "BINANDOP", "BINANDEQOP", "BINOROP", "BINOREQOP", "BINXOROP", "BINXOREQOP", "POINTERMEMBEROP", "MEMBEROP", "QUESTIONOP", "COLONOP", "ENDOF"};
